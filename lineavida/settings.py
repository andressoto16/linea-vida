"""
Django settings for lineavida project.
...
SECRET_KEY = 'django-insecure-o8w=0e!jh+6)-a)(ssnbzq=l(819)qp-9b-_^vo474uk5h&k7@'
...
WSGI_APPLICATION = 'lineavida.wsgi.application'
